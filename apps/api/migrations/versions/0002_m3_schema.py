...
def upgrade() -> None:
    ...
    # Canonical bundled-parquet schema as polars dtype names. Per the
    # design doc's "Data-frame library policy", the dataset's schema is
    # the typed contract; SDK code reads from this row, never hard-codes
    # the shape. Drift between this literal and the actual parquet bytes
    # is asserted by tests/test_bundled_dataset.py.
    op.execute(
        """
        ...
        VALUES (
          ...
          '{"date": "Date", "open": "Float64", "high": "Float64", "low": "Float64", "close": "Float64", "adj_close": "Float64", "volume": "Int64"}'::jsonb,
          'xxh64'
        )
